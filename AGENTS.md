...
- 內部連結格式：`/posts/{slug}/`，**不含日期**。slug 對應檔名去掉日期前綴的部分，例如檔案 `2026-02-25-Codex-cowork-ai-from-chat-to-work.md` 的連結是 `/posts/Codex-cowork-ai-from-chat-to-work/`
...
| **AI** | 7 | AI 相關：Vibe Coding、AI Agent、Codex Cowork、Agentic AI 等 |
