...
[淺談各種資料庫cache策略: cache aside、read through、write through、write back](/posts/databse-chache-strategies/)
...
1. [**MongoDB Write Concern**](https://docs.mongodb.com/manual/reference/write-concern/)
