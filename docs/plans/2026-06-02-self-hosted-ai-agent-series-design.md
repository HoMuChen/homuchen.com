...
| 3 | 部落格 | AI Agent 的記憶與檔案系統：memory、檔案記錄、漸進式揭露 | 已發布 | [/posts/ai-agent-memory-file-system/](https://homuchen.com/posts/ai-agent-memory-file-system/)（檔案 `posts/2026-06-14-ai-agent-memory-file-system.md`） |
...
| 9 | 部落格 | Hermes Agent 是什麼：會自己長記憶、長技能的 AI Agent | 已撰寫 | 草稿 `drafts/2026-07-03-hermes-ai-agent.md`（發布時移至 posts/，並把 #8 結語「下一篇 Hermes」的連結從 pillar 改指向 `/posts/hermes-ai-agent/`） |
